...
#Kenya 
county_gdf_ken=gpd.read_file(VECTOR_FOLDER+'geo_boundaries/Kenya/County.shp')
...
# Ethiopia  
county_gdf_eth=gpd.read_file(VECTOR_FOLDER+'geo_boundaries/Ethiopia/eth_admbnda_adm2_csa_bofedb_2021.shp') # admin 1 in ethiopia is too big 
county_gdf_eth=county_gdf_eth[['ADM2_EN','geometry']]
county_gdf_eth.rename(columns={'ADM2_EN':'county'}, inplace=True)

# Somalia
county_gdf_som=gpd.read_file(VECTOR_FOLDER+'geo_boundaries/Somalia/Som_Admbnda_Adm2_UNDP.shp')
county_gdf_som=county_gdf_som[['admin2Name','geometry']]
county_gdf_som.rename(columns={'admin2Name':'county'}, inplace=True)
...
for file in file_names: 
    ...
    print ('SM dataset construction finished')
